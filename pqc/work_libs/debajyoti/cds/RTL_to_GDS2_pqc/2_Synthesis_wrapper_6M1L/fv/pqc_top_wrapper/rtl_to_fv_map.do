...
# Generated on: Fri Jul 17 07:38:39 EDT 2026 (Fri Jul 17 11:38:39 UTC 2026)
...
set logfile fv/pqc_top_wrapper/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/pqc_top_wrapper -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/opt/tools/Cadence/CadenceTools/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/opt/tools/Cadence/CadenceTools/GENUS211/tools.lnx86"
set env(CW_DIR) "/opt/tools/Cadence/CadenceTools/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/opt/tools/Cadence/CadenceTools/GENUS211/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /opt/tools/Cadence/CadenceTools/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/opt/tools/Cadence/CadenceTools/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/opt/tools/Cadence/CadenceTools/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/opt/tools/Cadence/CadenceTools/GENUS211/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/opt/tools/Cadence/CadenceTools/GENUS211/tools.lnx86/lib/chipware/sim"
}
...
add_search_path ../rtl_7 -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../rtl_7/decryption_mn.v ../rtl_7/encrypt_top.v ../rtl_7/fpga_wrapper.v ../rtl_7/key_generation.v ../rtl_7/kyber_top.v ../rtl_7/poly_add.v ../rtl_7/poly_mult.v ../rtl_7/poly_reduce.v ../rtl_7/rounding.v ../rtl_7/sanitize_layer.v ../rtl_7/pqc_top_wrapper.v
elaborate_design -golden -root {pqc_top_wrapper} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/pqc_top_wrapper/fv_map.v.gz
elaborate_design -revised -root {pqc_top_wrapper}
...
#add_name_alias fv/pqc_top_wrapper/fv_map.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.pqc_top_wrapper.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.pqc_top_wrapper.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.pqc_top_wrapper.rtl.fv_map.rpt
