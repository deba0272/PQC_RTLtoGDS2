...
#  Generated on:      Fri Jul 17 11:04:07 2026
#  Design:            pqc_top_wrapper
#  Command:           create_ccopt_clock_tree_spec -file ./ClockTreeSynthesis/pqc_top_wrapper_ccopt.spec
###############################################################
#-------------------------------------------------------------------------------
...
#   clk (period 10.000ns) in timing_config all([top_streamed_wrapper_chip_pqc_sdc.sdc])
...
# Skew group to balance non generated clock:clk in timing_config:all (sdc top_streamed_wrapper_chip_pqc_sdc.sdc)
